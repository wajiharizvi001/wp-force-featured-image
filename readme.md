...
![Banner](assets/placeholder_image1_0.png)
Ever wanted to force a user to publish a post with a featured image of a certain dimension? Search no more.

**Contributors:** [WP Functions](https://wpfunctions.freesite.host), [wajiharizvi001](http://en.gravatar.com/jiyalikesart29)  
...
**Development of this plugin is done [on GitHub](https://github.com/wajiharizvi001/mentionable). Pull requests welcome. Please see [issues](https://github.com/wajiharizvi001/mentionable/issues) reported there before going to the plugin forum.**
